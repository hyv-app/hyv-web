  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        >
          <MetaThemeAndBgColor />
          <div className="flex flex-col min-h-dvh gap-10 relative z-10 bg-background max-w-[1440px] mx-auto">
            <TopBar />
            <div className="flex flex-col gap-14 md:gap-16 px-4 lg:px-6 pb-14 md:pb-16">
              {children}
            </div>
          </div>
          <Separator />
