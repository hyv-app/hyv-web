...
const Footer = () => {
    ...
    return (
        <div className="sticky z-0 bottom-0 w-full max-w-[1440px] mx-auto h-72 flex justify-center items-center px-4 pt-4 lg:px-6 lg:pt-6">
            <div className="relative overflow-hidden w-full h-full flex justify-end text-right items-start">
                <div className="flex flex-row space-x-12 sm:space-x-16 md:space-x-24 font-secondary">
                    ...
                    <ul className="flex flex-col gap-2 items-end">
                        ...
                        <li className="hover:underline cursor-pointer w-fit">Contact</li>
                        <li className="hover:underline cursor-pointer w-fit">Privacy Policy</li>
                    </ul>
                </div>
                <div className="absolute bottom-0 -left-2 translate-y-1/6 text-[156px] sm:text-[192px] bg-linear-to-r from-violet-400 via-cyan-400 to-lime-400 bg-clip-text text-transparent">
                    {APP_NAME}
                </div>
            </div>
        </div>
